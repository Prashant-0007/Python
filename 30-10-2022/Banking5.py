...
#Instance Method : CreateAccount(),Display_Acc_Info(), Deposit(), Withdraw()
...
def main():
    ...
    print("Amount Of User1 after depsite is :",User1.Amount)
    print("Amount Of User2 after deposite is :",User2.Amount)
